...
var headerSpacing = {
  paddingTop: /*#__PURE__*/isIphoneX() ? 44 : 20
};
var shadowBox = {
  elevation: 3.5,
  shadowOffset: {
...
var Heading = function Heading(_ref) {
  ...
  return React__default.createElement(Text$1, Object.assign({
    style: [_extends({
...
var TwilioConversationsProvider = function TwilioConversationsProvider(_ref) {
  ...
  var _React$useState3 = React__default.useState(new Map()),
      conversations = _React$useState3[0],
...
var ConversationList = function ConversationList(_ref) {
  ...
  return React__default.createElement(View, {
    ...
    bold: true,
    size: "2"
  }, "Messages"), React__default.createElement(TouchableOpacity, {
    hitSlop: {
      top: 15,
      bottom: 15,
      left: 15,
  ...
  }, React__default.createElement(IconSettings, null))), availableConversations && conversationsLoaded ? React__default.createElement(FlatList, {
...
var Item = function Item(_ref3) {
  ...
  return React__default.createElement(TouchableOpacity, {
    ...
    bold: hasNotBeenInteractedWith,
    size: 15
  }, hasOptedOut ? OPTED_OUT_MESSAGE : item.mostRecentMessage)), React__default.createElement(View, {
    style: styles$2.dateTimeContainer
  }, React__default.createElement(Text, {
    style: styles$2.datetime
  }, formatDate((lastMessage == null ? void 0 : lastMessage.dateCreated) || (item == null ? void 0 : item.dateCreated))), hasNewInteraction && React__default.createElement(View, {
    style: {
      marginTop: 15
    }
...
var Conversation = function Conversation(_ref) {
  ...
  var renderSystemMessage = function renderSystemMessage(props) {
    return React__default.createElement(SystemMessage, Object.assign({}, props, {
      containerStyle: {
        marginBottom: 15
      },
      textStyle: {
  ...
  var renderCustomInputToolbar = function renderCustomInputToolbar(props) {
    return React__default.createElement(InputToolbar, Object.assign({}, props, {
  ...
  var renderCustomComposer = function renderCustomComposer(props) {
    ...
    return React__default.createElement(Composer, Object.assign({}, props, {
...
var Conversation$1 = function Conversation$1(_ref4) {
  ...
  }, React__default.createElement(SafeAreaProvider, null, React__default.createElement(Conversation, Object.assign({
    webMode: true
  }, rest))));
};

export { Conversation$1 as Conversation, ConversationCenter, ConversationList };
