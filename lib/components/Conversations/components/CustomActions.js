...
const CustomActions = ({ onManualOfferPress = () => null, onSend = () => null, onCameraPressed = () => null, }, context) => {
    ...
    return (<View style={styles.wrapper}>
      ...
      <TouchableOpacity style={styles.container} onPress={onManualOfferPress} testID="manualOfferIcon">
